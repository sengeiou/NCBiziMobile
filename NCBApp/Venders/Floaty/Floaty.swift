...
open class Floaty: UIView {
   ...
   */
  @objc open var paddingX: CGFloat = 20 {
    didSet {
      self.setNeedsDisplay()
    }
  }
  @objc open var paddingY: CGFloat = 20 {
    didSet {
      self.setNeedsDisplay()
    }
  }
  ...
  @objc open var buttonImage: UIImage? = nil {
    ...
    @objc open var buttonImageFocus: UIImage? = nil {
        didSet {
            self.setNeedsDisplay()
        }
    }
  ...
  @objc public func open() {
    ...
    if buttonImageFocus != nil{
        buttonImageView.image = buttonImageFocus
    }
