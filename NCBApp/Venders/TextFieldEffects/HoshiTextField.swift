...
@IBDesignable open class HoshiTextField: TextFieldEffects {
    ...
    */
    ...
    private let placeholderInsets = CGPoint(x: 0, y: 5)//CGPoint(x: 0, y: 6)
    private let textFieldInsets = CGPoint(x: 0, y: 10)//CGPoint(x: 0, y: 12)
    ...
    private func layoutPlaceholderInTextRect() {        
        ...
        placeholderLabel.frame = CGRect(x: originX, y: textRect.height/2 - 8,
