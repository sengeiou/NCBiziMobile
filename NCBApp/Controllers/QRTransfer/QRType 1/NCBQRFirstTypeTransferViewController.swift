//
//  NCBQRFirstTypeTransferViewController.swift
//  NCBApp
//
...
class NCBQRFirstTypeTransferViewController: NCBBaseViewController {
    ...
    @IBOutlet weak var detinationAccountDetailLbl: UILabel!
    ...
    // MARK: - Variables
    var qrFirstTypeModel: NCBQRCodeFirstTypeScanModel? {
        didSet {
            setData()
        }
    }
